...
class _HomeState extends State<Home> {
  ...
  showAlertOnChangeLocation(LocationData currentLocation, DeliveryLocationData deliveryData, String house, String location) async {
    await Future.delayed(Duration(milliseconds: 50));
    String deliveryText = '';
    if (deliveryData != null) {
      deliveryText = deliveryData?.address ?? '';
      String house = deliveryData.house != null
          ? ', дом: ${deliveryData.house}'
          : '';
      String flat = deliveryData.flat != null
          ? ', кв.: ${deliveryData.flat}'
          : '';
  ...
  Future<void> setLocation(LocationData location, DeliveryLocationData deliveryData, String house) async {
  ...
  void initState() {
    ...
    super.initState();
      ...
      location.changeSettings(distanceFilter: 100, interval: 20000);
      ...
      location.onLocationChanged.listen((LocationData currentLocation) async {
        ...
        if ("${currentLocation.latitude.toString()}${currentLocation.longitude.toString()}" != "${deliveryLocationData?.lat?.toString()}${deliveryLocationData?.lon?.toString()}") {
          ...
          if (response.statusCode == 200) {
            ...
            showAlertOnChangeLocation(currentLocation, deliveryData, house, "${currentLocation.latitude.toString()},${currentLocation.longitude.toString()} ${deliveryLocationData?.lat?.toString()},${deliveryLocationData?.lon?.toString()}");
