...
class DeliveryWidget extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final suggestedData = useState<List<YandexGeoData>>(List<YandexGeoData>.empty());
    ...
    Future<void> getSuggestions (String query) async {
      ...
      var url = Uri.https('api.choparpizza.uz', 'api/geocode/query',
          {'query': query});
        ...
        return ListView.separated(itemBuilder: (context, index){
          return ListTile(onTap: (){
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => DeliveryModal(geoData: suggestedData.value[index],)));
          }, title: Text(suggestedData.value[index].title), subtitle: Text(suggestedData.value[index].description),);
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.search, color: Colors.yellow.shade600,),
                      SizedBox(width: 10,),
                      Flexible(
                        child: TextField(
                          ...
                          decoration: InputDecoration(hintText: 'Введите адрес', border: InputBorder.none,),
                        ),
                      ),
                      VerticalDivider(),
                      InkWell(
