      ...
      if (section.halfMode == 1) {
        ...
        sections.add(ListView.builder(
          ...
          itemBuilder: (_, prodIndex) =>
              renderProduct(tabContext!,
                  section.items?[prodIndex]),
        ));
      }
    });
  ...
  changeTabs() {
    ...
    if(scrolledIndex == 0) {
      if (scrollCont.offset == 0) {
        ...
        widget.parentScrollController.animateTo(widget.parentScrollController.position.maxScrollExtent,
            duration: Duration(milliseconds: 100), curve: Curves.easeIn);
      }
    }
